import { MoreVertical, ChevronLast, ChevronFirst, BarChart2, User, Users, BookOpen, Shield, Sun, Moon, Home, LogOut } from "lucide-react";
...
export default function Sidebar() {
  ...
  const navItems = [
    { icon: <BarChart2 size={20} />, text: "Statistiques", path: "" },
    { icon: <User size={20} />, text: "Profil", path: "profil" },
    { icon: <Users size={20} />, text: "Étudiants", path: "etudiants" },
    { icon: <BookOpen size={20} />, text: "Enseignants", path: "enseignants" },
    { icon: <Shield size={20} />, text: "Admins", path: "admins" }
  ];
